...
### GUIDE ###
async def send_instance_state(ctx, ec2_client, ec2_tag_value,
                              instance_launchtime, instance_az, instance_name):
...
async def purge(ctx, amount, user):
    ...
    if amount > 0 and user == None:
        ...
        await ctx.respond("You need to provide how many messages to purge.",
                          delete_after=1)
